...
class FreeFall(GraphScene):
    def __init__(self, **kwargs):
        GraphScene.__init__(self, x_min=0,
                            x_max=7,
                            y_min=0,
                            y_max=4,
                            y_axis_height=4,
    ...
    def construct(self):
        ...
        forcelaw = TexMobject(r"\vec F =  m\cdot \vec g")
        forcelaw.set_color(YELLOW)
        forcelaw.stre

        motion = TexMobject(r"\vec r=\vec r_0 + \vec v_0\cdot t+\tfrac{1}{2}\cdot \vec{g}\cdot t^2")
...
class ElasticCollision(GraphScene):
    def __init__(self, **kwargs):
        GraphScene.__init__(self, x_min=0,
                            x_max=14,
                            y_min=0,
    ...
    def construct(self):
        ...
        energy = TexMobject(r"\tfrac{1}{2}m_1 \cdot \vec v_1^2 + \tfrac{1}{2}m_2 \cdot \vec v_2^2 ="
                            r" \tfrac{1}{2}m_1 \cdot \vec u_1^2 + \tfrac{1}{2}m_2 \cdot \vec u_2^2 ")

        energy.set_color(YELLOW)

        momentum = TexMobject(r"m_1 \cdot \vec v_1 + m_2 \cdot \vec v_2 = m_1 \cdot \vec u_1 + m_2 \cdot \vec u_2")
    ...
    def get_equations(self):
        ...
        eq3 = TexMobject(r"M=m_1+m_2")
        eq4 = TexMobject(r"\cos\tfrac{\theta}{2}=\frac{b}{r_1+r_2}")
        eq1.scale(0.8)
        eq2.scale(0.8)
        eq3.scale(0.6)
        eq4.scale(0.6)
...
class SimpleHarmonicMotion(GraphScene):
    def __init__(self, **kwargs):
        GraphScene.__init__(self, x_min=0,
                            x_max=7,
                            y_min=-1,
    ...
    def construct(self):
        ...
        forcelaw = TexMobject(r"\vec F = - k \vec r")
        forcelaw.set_color(YELLOW)

        motion = TexMobject(r"\vec r=-\vec r_0\cdot \cos(\omega\cdot t) \hspace{3em} \omega^2=\frac{k}{m}")
        motion.set_color(BLUE)
        motion.move_to(RIGHT * 3 + UP * 2)
...
class DampedHarmonicMotion(GraphScene):
    def __init__(self, **kwargs):
        GraphScene.__init__(self, x_min=0,
                            x_max=7,
                            y_min=-1,
    ...
    def construct(self):
        ...
        forcelaw = TexMobject(r"\vec F = - k\cdot \vec r-b\cdot \vec v")
        forcelaw.set_color(YELLOW)
...
class Triangle(GraphScene):
    def __init__(self, **kwargs):
        GraphScene.__init__(self, x_min=-7,
                            x_max=7,
                            y_min=-4,
                            y_max=4,
                            y_axis_height=8,
...
class Code(Scene):
    def construct(self):
        ...
        i_gravity.move_to(RIGHT*(2+30/150)+UP*(3.5-251/150),UL) # means that the subimage is cut out at (30/251)
        ...
        f_gravity = TexMobject(r"\vec F = m\cdot \vec g \Longrightarrow \vec a_\text{gr} = \vec g")
        a_gravity = TexMobject(r"\vec a_\text{gr} = \vec g")
        ...
        f_floor = TexMobject(r"\vec F = -k_\text{fl}\cdot \vec h  \Longrightarrow \vec a_\text{fl} = \frac{k_\text{fl}}{m} h")
        a_floor = TexMobject(r"\vec a_\text{fl} = -\frac{k_\text{fl}}{m} \vec h_\perp")
        ...
        f_neighbour = TexMobject(
            r"\vec F_n = -k_\text{n}\cdot (\vec r-\vec r_\text{n}-\vec l_\text{n})-b \cdot (\vec v-\vec v_\text{n})")
        a_neighbour = TexMobject(r"\vec a_\text{n} = -\frac{k_\text{n}}{m} (\Delta\vec r_\text{n}-\vec l_\text{n})-\frac{b}{m}\cdot \Delta\vec v_\text{n}")
        ...
        a_air = TexMobject(r"\vec a_\text{nn} = -\frac{k_\text{air}}{m} (\Delta\vec r_\text{nn}-\vec l_\text{nn})")
        ...
        a_sum = TexMobject(r"\vec a_\text{full} = \vec a_\text{gr}+\vec a_\text{fl}+\sum_\text{n} \vec a_\text{n}+\sum_\text{nn} \vec a_\text{nn}+\vec a_\text{fr}")
...
class Code2(Scene):
    def construct(self):
        ...
        vel = TexMobject(r"\vec v_\text{new}=\vec v_\text{old}+\vec a_\text{full}\cdot dt")
        pos = TexMobject(r"\vec r_\text{new}=\vec r_\text{old}+\vec v_\text{new}\cdot dt")
